...
data_train_10 = cell2mat(trainingData.subs(1));
traindata = data_train_10(:,1:8);
trainlabels = data_train_10(:, 9);

lambda = [0.1, 1, 10, 100, 500, 1000];
CV_data_10 = CV_data_train.cv_data_10;
data2 = testingData.test;
testdata = data2(:, 1: 8);
testlabels = data2(:, 9);
CV_error = ones(5,1);
...
%% Cross Validation
for i = 1:6
CV_remain = cell2mat(CV_data_10(1));
CV_data1 = [cell2mat(CV_data_10(2)); cell2mat(CV_data_10(3)); cell2mat(CV_data_10(4)); cell2mat(CV_data_10(5))];
...
CV_remain = cell2mat(CV_data_10(2));
CV_data1 = [cell2mat(CV_data_10(1)); cell2mat(CV_data_10(3)); cell2mat(CV_data_10(4)); cell2mat(CV_data_10(5))];
CV_test = CV_remain(:, 1:8);
CV_testlabels = CV_remain(:,9);
CV_train = CV_data1(:,1:8);
CV_labels = CV_data1(:,9);
...
CV_remain = cell2mat(CV_data_10(3));
CV_data1 = [cell2mat(CV_data_10(1)); cell2mat(CV_data_10(2)); cell2mat(CV_data_10(4)); cell2mat(CV_data_10(5))];
CV_test = CV_remain(:, 1:8);
CV_testlabels = CV_remain(:,9);
CV_train = CV_data1(:,1:8);
CV_labels = CV_data1(:,9);
...
CV_remain = cell2mat(CV_data_10(4));
CV_data1 = [cell2mat(CV_data_10(1)); cell2mat(CV_data_10(2)); cell2mat(CV_data_10(3)); cell2mat(CV_data_10(5))];
CV_test = CV_remain(:, 1:8);
CV_testlabels = CV_remain(:,9);
CV_train = CV_data1(:,1:8);
CV_labels = CV_data1(:,9);
...
CV_remain = cell2mat(CV_data_10(5));
CV_data1 = [cell2mat(CV_data_10(1)); cell2mat(CV_data_10(2)); cell2mat(CV_data_10(3)); cell2mat(CV_data_10(4))];
CV_test = CV_remain(:, 1:8);
CV_testlabels = CV_remain(:,9);
CV_train = CV_data1(:,1:8);
CV_labels = CV_data1(:,9);
